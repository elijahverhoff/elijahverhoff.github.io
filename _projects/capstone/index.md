...
{% include image-gallery.html images="case1.png" %} <br>

{% include image-gallery.html images="case3.png" %} <br>



### Modeling Material Performance

{% include image-gallery.html images="plot1.png" %}
...
{% include image-gallery.html images="manufacturingFlowchart.png" %} <br>
